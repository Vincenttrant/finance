...
categories = {
    "Food": ["FOODS", "EATS", "TACO DINER", "NICK & SAM'S", "LOCHLANDS", "WHISKEY CAKE", "IN-N-OUT BURGER", "GRAND LUX CAFE", "THE RUSTIC", "EL FENIX", "CANTINA LAREDO", "FOGO DE CHAO", "P.F. CHANG'S", "CHICKEN N PICKLE", "BURGER KING", "SUBWAY", "STARBUCKS", "BLUE BOTTLE COFFEE", "OLIVE GARDEN", "KFC", "DUNKIN' DONUTS", "PEET'S COFFEE", "TAQUERIA TAXCO", "IHOP", "ORACL*WAFFLE HOUS", "85C BAKERY CAFE", "DAVES HOT CHICKEN", "TACO BELL", "BA LE RESTAURANT", "PIRANHA KILLER", "HAPPY LEMON", "CHICKEN EXPRESS", "SQ *KONA ICE", "BON K BBQ", "NINJARAMENANDROYA", "WHATABURGER", "RAISING CANES", "PORT OF SUBS", "MCDONALD'S", "CHIPOTLE", "TOUCH OF TOAST", "PANDA EXPRESS", "CHIPOTLE", "DINGTEA", "WICKED SNOW", "WINGSTOP", "PANDA EXPRESS", "CHICK-FIL-A", "210 BRAUMS STORE", "10402 CAVA CHAMPI"],
    "Shopping": ["CUT", "HAIRCUT", "CHINGONCUT", "NEIMAN MARCUS", "LOUIS VUITTON", "GALLERIA", "WILLIAMS SONOMA", "THE SHOPS AT LEGACY", "THE NORTH FACE", "DICK'S SPORTING GOODS", "SPOTIFY", "URBAN OUTFITTERS", "GAP", "NORDSTROM", "PEETS COFFEE", "ASOS", "H&M", "NETFLIX.COM", "HOME DEPOT", "COSTCO", "PRIME VIDEO", "KROGER", "HULU.COM", "WALGREENS", "LOWE'S", "EBAY", "eBayCommerce", "Alibaba.com", "APPLE", "Amazon.com", "Nike.com", "SP WATC STUDIO", "EDFINITY.COM", "MUSINSA", "WL *STEAM", "Zara.com", "UTA BOOKSTORE", "WAL Wal-Mart", "WM SUPERCENTER", "TARGET", "BEST BUY", "APPLE.COM/BILL", "Nike.com", "Birkenstock", "TARGET", "AMZN DIGITAL", "AMZN Mktp"],
    "Transportation": ["GAS", "CAR", "BUC-EE'S", "UBER RIDE", "LYFT RIDE", "FRONTIER", "QT", "MURPHY EXPRESS", "7-ELEVEN", "Upside", "UTA PARK TRANS"],
    "Finance": ["VENMO", "PAYPAL", "CHASE BANK", "GOLDMAN SACHS", "Cash App", "DISCOVER", "TRANSFER", "BKOFAMERICA", "UTA ARL MYMAV", "UT ARLINGTON"],
...
def machineLearning(data, data2):
    # Training data
